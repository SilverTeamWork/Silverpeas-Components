...
public class PostCriteria {
  ...
  public static PostCriteria from(String instanceId) {
    return new PostCriteria(instanceId);
  }

  protected PostCriteria(String instanceId) {
    this.instanceId = instanceId;
  }

  public PostCriteria withPagination(PaginationCriterion paginationCriterion) {
