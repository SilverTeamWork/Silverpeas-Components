 ...
 * @author ebonnet
 */
public class PostJpaManager extends JpaBasicEntityManager<Post, ExternalIntegerIdentifier>
    implements PostRepository {

  @Override
  public List<Post> getPaginatedPosts(final PostCriteria postCriteria) {
