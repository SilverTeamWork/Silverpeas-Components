...
/**
 * Servlet that handles the requests for the Ajax requests coming from the JSPWiki's web pages.
 * It extends the JSPWiki {@link WikiAjaxDispatcherServlet} class in order to set up the servlet
 * with the servlet context mapped with our own wiki engine.
 * <p>
 ...
 * their task. This is the case of the {@link WikiAjaxDispatcherServlet} servlet.
 * </p>
 * @author mmoquillon
 */
public class SilverWikiAjaxDispatcherServlet extends WikiAjaxDispatcherServlet {
